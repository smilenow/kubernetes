...
var _ = KubeDescribe("Graduation Relaxed Randomization", func(){
	...
	It("should setup 10 nodes, and submit 500 pods", func(){
		nodeNumber := 10
		podNumber := nodeNumber * 50
	...
	return &api.Node{
		...
		Status: api.NodeStatus {
			Capacity: api.ResourceList {
				...
				api.ResourceMemory: *resource.NewQuantity(161061200, resource.BinarySI), // 0.15 GB
			},
			Allocatable: api.ResourceList {
				...
				api.ResourceMemory: *resource.NewQuantity(161061200, resource.BinarySI),
			},
			...
			Containers: []api.Container {
				{
					...
					Resources: api.ResourceRequirements {
						Limits: api.ResourceList {
							...
							api.ResourceMemory: *resource.NewQuantity(1610612, resource.BinarySI),
						},
					},
				},
			},
